...
- Ports: no NEON matmul (needs a Pi Zero 2 W+ target); ESP32 hardware validation is a documented manual step; CI is green end-to-end on `main` (8/8 legs), baseline in `bench/baseline.json` reseeded from the Linux Release runner.
